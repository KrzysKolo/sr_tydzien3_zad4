...
const CardItem = ({city}) => {
    ...
    return (
        <Div>
            <H1><div style={styles}><FontAwesomeIcon icon={faHeart} style={{fontSize: "5vh", backgroundColor: 'ColorPalet["grey porcelain"]', transform: "translate(0, 30%)",}}/></div>  {city.name}<div style={styles}></div></H1>
