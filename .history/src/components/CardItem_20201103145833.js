...
const CardItem = ({city}) => {
    ...
    return (
        <Div>
            ...
            <FOOTER>
                <DivCircle>
                    <FontAwesomeIcon icon={faHeart} style={{transform: "translateX(50%"}}/>
                    <FontAwesomeIcon icon={faShareAlt} style={{transform: "translateX(50%"}}/>
                </DivCircle>
                <DivCircle>
                    <FontAwesomeIcon icon={faAngleDown} style={{transform: "translateX(50%"}}/>
                </DivCircle>
