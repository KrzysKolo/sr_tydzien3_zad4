...
const CardItem = ({city}) => {
    ...
    return (
        <Div>
            <H1><DivHeart><FontAwesomeIcon icon={faHeart} style={{fontSize: "5vh", color: 'ColorPalet["grey porcelain"]', transform: "translate(0, 25%)",}}/></DivHeart>  {city.name}<div style={styles}></div></H1>
