...
const CardItem = ({city}) => {
    ...
    return (
        <Div>
            <H1><div style={styles}><FontAwesomeIcon icon={faHeart} style={{fontSize: "5vh", color: '${PaletColors["swan white"]}', transform: "translate(-50%, -50%)",}}/></div>  {city.name}<div style={styles}></div></H1>
