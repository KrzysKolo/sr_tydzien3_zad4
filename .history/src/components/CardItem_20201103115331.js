...
const CardItem = ({city}) => {
    ...
    const DivHeart = styled.div`
        ...
        &:hover {
            ...
            box-shadow: 1px 3px 3px rgb(209, 204, 192);
        }
    `;
    const H1 = styled.h1`
    ...
    return (
        <Div>
            <H1><DivHeart><FontAwesomeIcon icon={faHeart} style={{fontSize: "5vh", color: "red", transform: "translate(0, 25%)",}}/></DivHeart>  {city.name}<div style={styles}></div></H1>
