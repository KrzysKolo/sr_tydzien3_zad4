...
const CardItem = ({city}) => {
    ...
    border: 2px solid ${PaletColors["swan white"]};
    border-radius: 50%;
    height: 7.5vh;
    width: 7.5vw;
    `;
    ...
    return (
        <Div>
            <H1><DivHeart style={styles}><FontAwesomeIcon icon={faHeart} style={{fontSize: "5vh", color: 'ColorPalet["grey porcelain"]', transform: "translate(0, 30%)",}}/></DivHeart>  {city.name}<div style={styles}></div></H1>
